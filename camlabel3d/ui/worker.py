"""Background worker used for non-blocking WildDet3D inference."""
...
class DetectionWorker(QThread):
    """Run frame or range inference on a background thread."""
...
class WarmupWorker(QThread):
    """Warm up one WildDet3D model variant without blocking the UI."""
...
class TrackingWorker(QThread):
    """Run offline tracking on the current latest records."""
