...
WILDDET3D_ROOT = PROJECT_ROOT / "workers" / "WildDet3D"
...
LOCAL_CHECKPOINTS = [
    str(PROJECT_ROOT / "ckpts" / "wilddet3d_alldata_all_prompt_v1.0.pt"),
    str(WILDDET3D_ROOT / "ckpt" / "wilddet3d_alldata_all_prompt_v1.0.pt"),
    "ckpt/wilddet3d_alldata_all_prompt_v1.0.pt",
    "ckpt/wilddet3d.pt",
    str(WILDDET3D_ROOT / "ckpt" / "wilddet3d.pt"),
]
