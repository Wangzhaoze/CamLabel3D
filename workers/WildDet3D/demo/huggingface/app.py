...
_WILDDET3D_ROOT = os.path.dirname(os.path.dirname(_SCRIPT_DIR))
_PROJECT_ROOT = os.path.dirname(os.path.dirname(_WILDDET3D_ROOT))

# Local checkpoint paths (tried in order)
LOCAL_CHECKPOINTS = [
    os.path.join(_PROJECT_ROOT, "ckpts", "wilddet3d_alldata_all_prompt_v1.0.pt"),
    os.path.join(_WILDDET3D_ROOT, "ckpt", "wilddet3d_alldata_all_prompt_v1.0.pt"),
